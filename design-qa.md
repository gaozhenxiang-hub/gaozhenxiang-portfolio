...
17. **Video content replacement:** Positions 13 through 22 now follow the exact supplied-file order and approved English copy. A content regression test locks the first twelve ids, titles, descriptions, and image paths, and confirms none of those entries gained a video source.
18. **Performance preparation:** The ten untouched source files totaled roughly 210 MB and included 2K/48 fps/60 fps material. Their web copies are H.264/yuv420p, at most 1280 px wide and 30 fps, with fast-start metadata. Ten MP4 files plus ten WebP posters total 39.15 MB.
